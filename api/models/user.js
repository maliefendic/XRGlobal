...
module.exports = (sequelize, DataTypes, Sequelize) => {
  ...
  User.associate = (models) => {
    ...
    models.user.belongsTo(models.branch_user)

  }

  //for branch we will provide autogenerated password
  User.addHook('beforeCreate', async (user) => {
    const password = generator.generate({ length: 10, numbers: true });
    if (this.roleId == USERTYPE.branch) {
      user.password = branch + password + this.organizationId
    }
